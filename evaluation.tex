...
また\wtab{Q}に、各条件でのQ値を示す。
2号機つまみ最大に関しては、測定点が足りずQ値を算出できなかった。
...
\begin{table}[H]
	...
	\label{tab:Q}
	\begin{tabular}{ccccccc} \hline
		     & 最大電圧[V] & 最大電圧/\(\sqrt{2}\) & 共振周波数\(\omega_0\) & \(\omega_1\) & \(\omega_2\) & Q値    \\ \hline
		1min & 4.71    & 3.33              & 495               & 447          & 555          & 4.583 \\
		1max & 4.64    & 3.28              & 1410              & 1100         & 2050         & 1.484 \\
		2min & 4.89    & 3.46              & 305               & 250          & 360          & 2.773 \\
		2max & 4.30    & 3.04              & 890               & 530          & 1400         & 1.023 \\ \hline
	\end{tabular}
\end{table}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{fig/min_max2_v2.pdf}
	\caption{バリアブルコンデンサ測定回路の共振}
	\label{fig:inda5}
\end{figure}
